# -*- coding: utf-8 -*-
"""
Created on Wed Jun 30 10:27:17 2021
...
def sign_out(server, auth_token):
    ...
    """
    url = server + "/api/3.11/auth/signout"
...
def execute():
    ...
    # Default site
    source_auth_token, source_site_id, source_user_id = sign_in(server, username, password, site=source_site)
